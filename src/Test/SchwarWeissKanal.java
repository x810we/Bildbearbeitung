    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int y = 0; y < inputImage.getHeight(); y++) {
            for (int x = 0; x < inputImage.getWidth(); x++) {
                ...
                double greyDouble = color.getGreen();
        ...
        ImageIO.write(outputImage, "jpg", new File("/Users/810we/Library/Mobile Documents/X6B29J8D22~com~savysoda~documents/Documents/Daten/04 Technik/91 Fotographie/13 Fotobücher/Bildbearbeitung/Fotos/01  SchwarzWeiss/Muster-SchwarzWeissKanal.jpg"));
    }
}